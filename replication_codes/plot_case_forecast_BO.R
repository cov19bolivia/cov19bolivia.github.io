...
# Save for gif
#ggsave(filename = paste0("casesf/", vintage, "/", gsub("\\s+","",filename), "casefv2gif.png"), plot = p1, width = 10, height = 6, dpi = 300, units = "cm")

# Save for tweet
#ggsave(filename = paste0("casesf/", vintage, "/", gsub("\\s+","",filename), "casefv2tweet.png"), plot = p1, width = 12, height =6, dpi = 300, units = "cm")
